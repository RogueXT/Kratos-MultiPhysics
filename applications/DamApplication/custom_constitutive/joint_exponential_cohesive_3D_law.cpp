...
int JointExponentialCohesive3DLaw::Check(const Properties& rMaterialProperties,const GeometryType& rElementGeometry,const ProcessInfo& rCurrentProcessInfo) const
{
...
void JointExponentialCohesive3DLaw::InitializeMaterial( const Properties& rMaterialProperties,const GeometryType& rElementGeometry,const Vector& rShapeFunctionsValues )
{
...
void JointExponentialCohesive3DLaw::FinalizeMaterialResponseCauchy (Parameters& rValues)
{
...
double& JointExponentialCohesive3DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
{
...
void JointExponentialCohesive3DLaw::InitializeConstitutiveLawVariables(ConstitutiveLawVariables& rVariables,
                                                                    Parameters& rValues)
...
double JointExponentialCohesive3DLaw::MacaulayBrackets(const double& Value)
{
    if(Value > 0.0)
        return Value;
    else
...
void JointExponentialCohesive3DLaw::ComputeEquivalentStrain(ConstitutiveLawVariables& rVariables,
                                                        Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();
...
void JointExponentialCohesive3DLaw::ComputeDamageVariable(ConstitutiveLawVariables& rVariables,
                                                        Parameters& rValues)
{
    mDamageVariable = 1.0 - (1.0 + (mStateVariable / rVariables.CriticalDisplacement)) * std::exp(-mStateVariable / rVariables.CriticalDisplacement);
...
void JointExponentialCohesive3DLaw::ComputeCriticalDisplacement(ConstitutiveLawVariables& rVariables,
                                                            Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();
    const Properties& MaterialProperties = rValues.GetMaterialProperties();
...
void JointExponentialCohesive3DLaw::ComputeConstitutiveMatrix(Matrix& rConstitutiveMatrix,
...
void JointExponentialCohesive3DLaw::ComputeStressVector(Vector& rStressVector,
                                                ConstitutiveLawVariables& rVariables,
                                                Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();
