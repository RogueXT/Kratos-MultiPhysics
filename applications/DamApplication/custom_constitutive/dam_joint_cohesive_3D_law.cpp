...
#include "custom_constitutive/dam_joint_cohesive_3D_law.hpp"

namespace Kratos
{

void DamJointCohesive3DLaw::GetLawFeatures(Features& rFeatures)
{
    //Set the type of law
...
int DamJointCohesive3DLaw::Check(const Properties& rMaterialProperties,const GeometryType& rElementGeometry,const ProcessInfo& rCurrentProcessInfo) const
{
...
void DamJointCohesive3DLaw::InitializeMaterial( const Properties& rMaterialProperties,const GeometryType& rElementGeometry,const Vector& rShapeFunctionsValues )
{
    mStateVariable = 0.0;
    mUpliftPressure = 0.0;
}
...
void DamJointCohesive3DLaw::CalculateMaterialResponseCauchy (Parameters& rValues)
{
    //Check
...
void DamJointCohesive3DLaw::FinalizeMaterialResponseCauchy (Parameters& rValues)
{
...
double& DamJointCohesive3DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
{
...
void DamJointCohesive3DLaw::SetValue( const Variable<double>& rThisVariable, const double& rValue,
...
void DamJointCohesive3DLaw::InitializeConstitutiveLawVariables(ConstitutiveLawVariables& rVariables,
                                                                Parameters& rValues)
...
void DamJointCohesive3DLaw::ComputeEquivalentStrain(ConstitutiveLawVariables& rVariables,
                                                    Parameters& rValues)
{}

//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

void DamJointCohesive3DLaw::CheckLoadingFunction(ConstitutiveLawVariables& rVariables,
                                                    Parameters& rValues)
{}

//----------------------------------------------------------------------------------------

void DamJointCohesive3DLaw::ComputeConstitutiveMatrix(Matrix& rConstitutiveMatrix,
...
void DamJointCohesive3DLaw::ComputeStressVector(Vector& rStressVector,
                                                ConstitutiveLawVariables& rVariables,
                                                Parameters& rValues)
{
