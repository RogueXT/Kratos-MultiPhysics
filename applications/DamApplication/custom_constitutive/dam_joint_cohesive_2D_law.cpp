...
#include "custom_constitutive/dam_joint_cohesive_2D_law.hpp"

namespace Kratos
{

void DamJointCohesive2DLaw::GetLawFeatures(Features& rFeatures)
{
    //Set the type of law
...
void DamJointCohesive2DLaw::ComputeEquivalentStrain(ConstitutiveLawVariables& rVariables,
                                                         Parameters& rValues)
{}

//----------------------------------------------------------------------------------------

void DamJointCohesive2DLaw::ComputeConstitutiveMatrix(Matrix& rConstitutiveMatrix,
...
void DamJointCohesive2DLaw::ComputeStressVector(Vector& rStressVector,
                                                     ConstitutiveLawVariables& rVariables,
                                                     Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();
