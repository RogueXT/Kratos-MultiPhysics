...
void JointExponentialCohesive2DLaw::InitializeConstitutiveLawVariables(ConstitutiveLawVariables& rVariables,
                                                                    Parameters& rValues)

{
    ...
    if(std::abs(MinusNormalStrain) > 1.0e-15)
        rVariables.CompressionMatrix(1,1) = 1e6 * this->MacaulayBrackets(MinusNormalStrain)/MinusNormalStrain;
...
void JointExponentialCohesive2DLaw::ComputeEquivalentStrain(ConstitutiveLawVariables& rVariables,
                                                        Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();
...
void JointExponentialCohesive2DLaw::ComputeCriticalDisplacement(ConstitutiveLawVariables& rVariables,
                                                            Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();
    const Properties& MaterialProperties = rValues.GetMaterialProperties();
...
void JointExponentialCohesive2DLaw::ComputeConstitutiveMatrix(Matrix& rConstitutiveMatrix,
                                                        ...
                                                        Parameters& rValues)
{
    ...
    KRATOS_WATCH(rConstitutiveMatrix(0,0))
    KRATOS_WATCH(rConstitutiveMatrix(0,1))
    KRATOS_WATCH(rConstitutiveMatrix(1,0))
    KRATOS_WATCH(rConstitutiveMatrix(1,1))
}

//----------------------------------------------------------------------------------------

void JointExponentialCohesive2DLaw::ComputeStressVector(Vector& rStressVector,
                                                ConstitutiveLawVariables& rVariables,
                                                Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();
